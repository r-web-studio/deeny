...
import { Download, X, Smartphone, Share, Globe, Menu, ArrowUp } from 'lucide-react';
          ...
          <div className="relative overflow-hidden rounded-2xl border border-islamic-green/20 bg-card/95 shadow-2xl shadow-islamic-green/10 backdrop-blur-xl">
            ...
            <div className="relative flex items-center gap-3 p-4">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold text-foreground">Install Sakinah</p>
                <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                  {isIOS
                    ? 'Install to your home screen for the best experience'
              ...
              <div className="flex items-center gap-2 flex-shrink-0">
                {isIOS ? (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-islamic-green to-islamic-green/90 px-4 py-2 text-xs font-semibold text-white shadow-md shadow-islamic-green/20 transition-all hover:shadow-lg hover:shadow-islamic-green/30 hover:scale-[1.02] active:scale-[0.98]"
                  >
            ...
            {showInstructions && isIOS && (
              ...
              >
                <div className="p-4 space-y-3">
                  <p className="text-xs font-medium text-foreground">How to install on iOS:</p>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-islamic-green/10 text-islamic-green text-xs font-bold flex-shrink-0">1</div>
                      <div className="text-xs text-muted-foreground">
                        Tap the <span className="inline-flex items-center gap-0.5 font-medium text-foreground"><ArrowUp className="inline h-3 w-3" /> Share</span> button in Safari
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-islamic-green/10 text-islamic-green text-xs font-bold flex-shrink-0">2</div>
                      <div className="text-xs text-muted-foreground">
                        Scroll down and tap <span className="font-medium text-foreground">&quot;Add to Home Screen&quot;</span>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="flex h-6 w-6 items-center justify-center rounded-full bg-islamic-green/10 text-islamic-green text-xs font-bold flex-shrink-0">3</div>
                      <div className="text-xs text-muted-foreground">
                  ...
                  <p className="text-[11px] text-muted-foreground/70 pt-1">
                    Once installed, you&apos;ll get notifications and offline access
                  </p>
                </div>
              </motion.div>
            )}
                  ...
                  <div className="space-y-2 text-xs text-muted-foreground">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p>Click the three-dot menu → &quot;Install Sakinah&quot;</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
