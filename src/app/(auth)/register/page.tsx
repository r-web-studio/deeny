    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <Card className="glass-strong shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start your spiritual productivity journey</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="fullName" placeholder="Your name" className="pl-10" {...register("fullName")} />
              </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="text-islamic-green hover:underline font-medium">Sign in</Link>
          </p>
        </CardContent>
      </Card>
    </motion.div>
